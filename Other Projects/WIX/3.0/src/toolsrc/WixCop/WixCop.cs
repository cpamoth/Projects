...
namespace Microsoft.Tools.WindowsInstaller.Tools
{
    ...
    public class WixCop
    {
        ...
        private void ParseSettingsFiles(string settingsFile1, string settingsFile2)
        {
            ...
            Hashtable ignoreErrorsHash = new Hashtable();
            ...
            do
            {
                ...
                try
                {
                    ...
                    {
                        ignoreErrorsHash[((XmlElement)test).GetAttribute("Id")] = null;
                    }
            ...
            this.ignoreErrorsHash = new string[ignoreErrorsHash.Keys.Count];
            ignoreErrorsHash.Keys.CopyTo(this.ignoreErrorsHash, 0);
        }
