...
namespace Microsoft.VisualStudio.Package
{
		...
		IVsCfgBrowseObject
	{
		...
		private List<OutputGroup> outputGroups = new List<OutputGroup>();
		...
		public IProjectConfigProperties ConfigurationProperties
		{
			get
			{
				...
				return (IProjectConfigProperties)this.configurationProperties;
			}
		}
		#endregion
		...
		private string DisplayName
		{
			get
			{
				...
				Debug.Assert(provider is IVsCfgProvider2, " The config provider must implement IVsCfgProvider2");
