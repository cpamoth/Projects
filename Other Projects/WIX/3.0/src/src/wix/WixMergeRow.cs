    ...
    public sealed class WixMergeRow : Row
    {
        ...
        public YesNoType FileCompression
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.InvariantCulture, "A Merge table FileCompression column contains an invalid value '{0}'.", this.Fields[5].Data));
                }
            }
            set
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.InvariantCulture, "A Merge table FileCompression column cannot be set to the invalid value '{0}'.", value));
                }
            }
        }
