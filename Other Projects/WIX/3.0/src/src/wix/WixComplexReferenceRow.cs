...
namespace Microsoft.Tools.WindowsInstallerXml
{
    ...
    public enum ComplexReferenceParentType
    {
        ...
        /// <summary>Group parent of complex reference.</summary>
        Group,
    ...
    public enum ComplexReferenceChildType
    {
        ...
        /// <summary>Group child of complex reference.</summary>
        Group,
    ...
    public sealed class WixComplexReferenceRow : Row, IComparable
    {
        ...
        public int CompareToWithoutConsideringPrimary(object obj)
        {
            ...
            if (null == other)
            {
                throw new ArgumentException("Expected ComplexReference type.", "obj");
            }

            int comparison = this.ChildType - other.ChildType;
            if (0 == comparison)
            {
                comparison = this.ChildId.CompareTo(other.ChildId);
                if (0 == comparison)
                {
                    ...
                    if (0 == comparison)
                    {
                        ...
                        comparison = thisParentLanguage.CompareTo(otherParentLanguage);
                        if (0 == comparison)
                        {
                            comparison = this.ParentId.CompareTo(other.ParentId);
                        }
                    }
                }
            }
