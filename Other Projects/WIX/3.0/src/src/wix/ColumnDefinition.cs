        ...
        public string GetIdtType()
        {
            ...
            switch (this.type)
            {
                ...
                case ColumnType.Object:
                    ...
                    break;
                default:
                    throw new InvalidOperationException(String.Concat("Unknown column type: ", this.type));
            }
                    ...
                    case "category":
                        switch (reader.Value)
                        {
                            ...
                            case "wildCardFilename":
                                ...
                                break;
                            default:
                                throw new WixException(WixErrors.IllegalAttributeValue(SourceLineNumberCollection.FromUri(reader.BaseURI), "columnDefinition", reader.Name, reader.Value, "anyPath", "binary", "cabinet", "condition", "customSource", "defaultDir", "doubleInteger", "filename", "formatted", "guid", "identifier", "integer", "language", "lowerCase", "path", "paths", "property", "regPath", "shortcut", "template", "text", "timeDate", "upperCase", "version", "wildCardFilename"));
                        }
                        break;
                    case "description":
