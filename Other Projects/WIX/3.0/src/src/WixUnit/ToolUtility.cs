        ...
        public static ArrayList GetErrors(ArrayList output, string expectedErrors, string expectedWarnings)
        {
            ...
            foreach (string line in output)
            {
                ...
                else
                {
                    ...
                    {
                        int errorNumber = Convert.ToInt32(errorMatch.Groups["errorNumber"].Value, CultureInfo.InvariantCulture);
                    ...
                    {
                        int warningNumber = Convert.ToInt32(warningMatch.Groups["warningNumber"].Value, CultureInfo.InvariantCulture);
